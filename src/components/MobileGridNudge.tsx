 ...
 *
 * Renders nothing when there's no next-slide overflow to hint at — the
 * caller (`DataView`) is responsible for reserving this column's width
 * only when this actually renders, and for rendering the plain duplicate
 * line below the whole row itself (this component only owns the column).
